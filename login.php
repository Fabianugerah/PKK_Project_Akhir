...
<body>
    ...
    <section class="py-3 py-md-5 py-xl-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="mb-2">
                        <h2 class="display-5 fw-bold text-center">Masuk</h2>
                ...
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="row gy-5 justify-content-center">
                        <div class="col-12 col-lg-5">
                            <form action="luxev.php" id="loginForm">
                                <div class="row gy-3 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <div id="passwordError" class="error-message d-none text-danger">Password harus lebih dari 8 karakter!</div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-lg btn-dark rounded fs-6" type="submit">
                                                Log in
                                            </button>
                                        </div>
                                    </div>
    ...
    document.getElementById("loginForm").addEventListener("submit", function(event) {
        ...
        if (isValid) {
            ...
            this.submit(); // Anda dapat mengganti dengan aksi lainnya seperti AJAX
        }
    });
    </script>
</body>
